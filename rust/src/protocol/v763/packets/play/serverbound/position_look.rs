...
//! python/minecraft_bot/protocol/v763/packets/play/serverbound/position_look.py.
...
/// PositionLook packet body (auto-generated).
...
impl ServerboundPacket for PositionLook {
