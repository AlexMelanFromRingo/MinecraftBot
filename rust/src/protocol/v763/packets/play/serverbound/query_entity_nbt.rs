...
//! python/minecraft_bot/protocol/v763/packets/play/serverbound/query_entity_nbt.py.
...
/// QueryEntityNbt packet body (auto-generated).
...
impl ServerboundPacket for QueryEntityNbt {
