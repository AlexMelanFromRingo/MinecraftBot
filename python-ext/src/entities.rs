...
impl PyEntity {
    ...
    #[getter] fn entity_id(&self) -> i32 { self.inner.entity_id }
    #[getter] fn type_id(&self) -> i32 { self.inner.type_id }
    ...
    #[getter] fn vx(&self) -> i16 { self.inner.vx }
    #[getter] fn vy(&self) -> i16 { self.inner.vy }
    #[getter] fn vz(&self) -> i16 { self.inner.vz }
    #[getter] fn health(&self) -> Option<f32> { self.inner.health }
    ...
    fn __repr__(&self) -> String {
        format!(
            ...
            self.inner.entity_id, self.inner.type_id,
