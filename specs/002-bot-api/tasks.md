...
- [X] T089 [P] Update `README.md` at repo root — note the Bot API milestone, add `pip install -e python/[dev]` plus a 5-line "hello bot" example.
- [X] T090 Run `quickstart.md` end-to-end on a clean checkout — all 7 quickstart scripts succeed against a live server.
- [X] T091 [P] CI matrix update — extend `.github/workflows/ci.yml` (added in 001) to include the new test files in default + live runs.
